...
<AccordionGroup>
  <Accordion icon="user-plus" title="Sign Up Process">
    ...
    3. Choose your preferred signup method:
        ...
        <img src="images/sign-up.png" alt = "Sign Up" width="300" height="200"/>
  ...
  <Accordion icon="arrow-right-to-bracket" title="Login Process">
    ...
    <img src = "images/login.png" alt = "Login Screen" width = "300" height ="200"/>
...
{/* <CardGroup> */}
  ...
  <Frame>
    <img src="images/agents.png" alt="Agents Screen" />
  </Frame>
...
<AccordionGroup>
  <Accordion icon="dashboard" title="Dashboard Overview">
  ...
  <Accordion icon="map" title="Key Sections">
    Essential areas of the dashboard:
    - Home: Your main overview
